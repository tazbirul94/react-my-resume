const resume = {
  "basics": {
    ...
    "picture": "images/galaxy head.jpg",
  ...
  "work": [
    {
      ...
      "position": "Software Development Experte (Vollzeit)",
      "website": "https://karriere.eventim.de/en/",
      "startDate": "2023/07/01",
      "endDate": "Present",
      "summary": "C#, Asp.Net Core, RESTful API, YAML Gitlab CI/CD Pipeline, MS SQL, Entity Framework, RabbitMQ, Git, Docker",
      "highlights": [
    ...
    },
    {
      ...
      "position": "Senior Full Stack Entwickler (Vollzeit)",
    ...
    },
    {
      "company": "Swiss Re (Movingdots GmbH)",
      "logo": "images/swiss-re-logo.png",
      "position": "Full Stack Entwickler (Vollzeit)",
      "website": "https://www.movingdots.com/",
    ...
    },
    {
      ...
      "position": "Software Engineer (Werkstudent)",
    ...
    },
    {
      ...
      "position": "Programmierer (Vollzeit)",
    ...
    },
    {
      ...
      "position": "IT-Ingenieur (Vollzeit)",
  ...
  "interests": [
    { "name": "Fotografie", "keywords": ["Landschaften", "Natur", "Straße"] },
    { "name": "Reisen", "keywords": ["Städtetrips", "Wandern"] },
    { "name": "Kochen", "keywords": ["Bangladeschisch", "BBQ", "Experimentieren"] },
    { "name": "DIY-Projekte", "keywords": ["Quilling", "Origami", "Puzzles"] },
    { "name": "Musik", "keywords": ["Gitarre", "Klavier", "Spotify"] }
  ],
  "references": [
    {
      "name": "Md Shahabub Alam",
      "position": "Wissenschaftlicher Mitarbeiter | NLP, Deep Learning & Computer Vision",
      "company": "DFKI",
      "reference": "Er ist sehr leidenschaftlich und hochqualifiziert. Er weiß genau, was er tut, was sehr geschätzt werden kann. Außerdem kann er komplexe Probleme in kleinere Teile zerlegen, was hilft, sie in angemessener Zeit zu lösen."
    }
  ],
  "skills": [
  {
    ...
    "description": [
      "<BESCHREIBUNG_1>", "<BESCHREIBUNG_2>", "<BESCHREIBUNG_3>"
    ],
    "skillDetails": [
      {
        "name": "<FÄHIGKEITSNAME>",
        "level": "<FÄHIGKEITSSTUFE>",
        "keywords": ["<SCHLAGWORT_1>", "<SCHLAGWORT_2>", "<SCHLAGWORT_3>"]
      }
    ]
  }
],
"softskills": [
  {
    ...
    "description": [
      "Starke Kommunikation und Zusammenarbeit in internationalen Teams.",
      "Analytisches und lösungsorientiertes Arbeiten.",
      "Hohe Anpassungsfähigkeit und Lernbereitschaft."
    ],
    "skillDetails": [
      { "name": "Teamarbeit", "level": 85 },
      { "name": "Kommunikation", "level": 80 },
      { "name": "Problemlösung", "level": 90 },
      { "name": "Zeitmanagement", "level": 75 },
      { "name": "Führungskompetenz", "level": 70 },
      { "name": "Anpassungsfähigkeit", "level": 80 },
